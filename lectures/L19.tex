% this lecture is a bit jumping-all-over-the place
% 80 minutes
...
\lecture{19 --- February 23, 2015}{Winter 2015}{Patrick Lam}{version 1}
...
OpenMP uses a {\bf relaxed-consistency, shared-memory} model. This doesn't 
...
\paragraph{Final thoughts on flush.} We've seen that it's very difficult to use flush properly. Really, you should be using mutexes or other synchronization instead of flush\footnote{\url{http://www.thinkingparallel.com/2007/02/19/please-dont-rely-on-memory-barriers-for-synchronization/}}, because you'll probably just get it wrong. But now you know what flush means.
